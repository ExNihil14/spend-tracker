...
> **Ждёт коммита/push юзера. Следующее — волна 3: канал данных с PWA-уклоном.**
> **АКТУАЛЬНО (18.09, вечер): волна 2 — дайджест недели + флаги аномалий (S+S) реализованы; ждут коммита/push юзера.**
