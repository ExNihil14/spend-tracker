...
> #4 data-gated окончательно; ЮMoney CSV кошелька публично не подтверждён (PDF/JSON). **Решение за юзером:**
> поправить публичную формулировку «XLS-импорт в планах» (README/лендинг) на честную. Контур: **512 unit +
