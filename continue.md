...
> **АКТУАЛЬНО (21.09, сессия «гигиена репо» после тяжёлого ревью — ждёт команды на коммит).**
...
> принят тест-гэп (README/supporter.yml) — `EXPERT_REVIEW_HYGIENE_OR.md`. Коммит/push — по явной команде юзера.
