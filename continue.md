...
> **АКТУАЛЬНО (15.09): 135 unit + 13 e2e зелёные, ruff чист; `main` = `2e12d6c` (Фаза 3 /settings), впереди origin на 1 коммит — ждёт push юзера. Ревью OpenRouter (nemotron-3-ultra-550b:free, $0) — GO с правками, P1 применены.** Ниже — исторические снимки; цифры в них не актуальны.
